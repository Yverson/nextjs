...
import { CfdisListFilterHeader } from "./fdisListFilterHeader";
import { PaginationState } from "@tanstack/react-table";
import { useQuery } from "react-query";
import { FilterfdisData, fdisListTableDataColumn } from "./columns";
import ReactPaginate from "react-paginate";
import "./styles.css";
import { useDispatch } from "react-redux";
import { fetchData, setSearcParam, setrefresh } from "./fdisslice";
import { useAppSelector } from "@/Redux/Hooks";
import Createfdis from "./Createfdis";
import Editfdis from "./Editfdis";
import Deletefdis from "./Deletefdis";

const CfdisListContainer = () => {
  const dispatch = useDispatch();
  const [filterText, setFilterText] = useState("");
  const { refresh, searcParam, fdisFilter } = useAppSelector(
    (state) => state.fdis
  );
          ...
          <Card>
            <CardBody>
              <div className="list-product-header">
                ...
                <Editfdis />
                <Deletefdis />
                <CfdisListFilterHeader />

                <Collapse isOpen={fdisFilter}>
              ...
              <div className="list-product">
                <div className="table-responsive">
                  <DataTable
                    ...
                    columns={fdisListTableDataColumn}
                    striped
                    highlightOnHover
                    subHeader
...
export default CfdisListContainer;
