...
import { FilterdossiersencourData, dossiersencourListTableDataColumn } from "./columns";
import ReactPaginate from "react-paginate";
import "./styles.css";
import { useDispatch } from "react-redux";
import { fetchAttestationData, fetchData, setSearcParam, setrefresh } from "../dossiers/dossiersslice";
                ...
                <Collapse isOpen={dossiersFilter}>
                  <Card className="shadow-none">
                      ...
                      <Row className="row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-2 g-3">
                        {FilterdossiersencourData.map((item, index) => (
                          <Col key={index}>
                            <Input
                              type="select"
                              onChange={(e) =>
