...
import { CclientsListFilterHeader } from "./clientsListFilterHeader";
import { PaginationState } from "@tanstack/react-table";
import { useQuery } from "react-query";
import { FilterclientsData, clientsListTableDataColumn } from "./columns";
...
const CclientsListContainer = () => {
  ...
  const { refresh, searcParam, clientsFilter } = useAppSelector(
    (state) => state.clients
  );
            ...
            <CardBody>
                ...
                <div className="table-responsive">
                  <DataTable
                    ...
                    columns={clientsListTableDataColumn}
                    striped
                    highlightOnHover
                    subHeader
