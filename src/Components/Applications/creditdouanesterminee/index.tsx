...
import { credit_douanesTerminerListTableDataColumn } from "./columns";
import ReactPaginate from "react-paginate";
import "./styles.css";
import { useDispatch } from "react-redux";
import { setSearcParam, setrefresh } from "./credit_douanesslice";
import { useAppSelector } from "@/Redux/Hooks";

import { fetchTerminerData } from "../dossiers/dossiersslice";
            ...
            <CardBody>
                ...
                <div className="table-responsive">
                  <DataTable
                    ...
                    columns={credit_douanesTerminerListTableDataColumn}
                    striped
                    highlightOnHover
                    subHeader
