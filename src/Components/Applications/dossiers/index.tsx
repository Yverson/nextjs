...
import { CdossiersListFilterHeader } from "./dossiersListFilterHeader";
import { PaginationState } from "@tanstack/react-table";
import { useQuery } from "react-query";
import { FilterdossiersData, dossiersListTableDataColumn } from "./columns";
import ReactPaginate from "react-paginate";
import "./styles.css";
import { useDispatch } from "react-redux";
import { fetchData, setSearcParam, setrefresh } from "./dossiersslice";
import { useAppSelector } from "@/Redux/Hooks";
import Createdossiers from "./Createdossiers";
import Editdossiers from "./Editdossiers";
import Deletedossiers from "./Deletedossiers";

const CdossiersListContainer = () => {
        ...
        <Col sm="12">
          <Card>
            <CardBody>
                ...
                <Editdossiers />
                <Deletedossiers />
                <CdossiersListFilterHeader />

                <Collapse isOpen={dossiersFilter}>
                  <Card className="shadow-none">
                      ...
                      <Row className="row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-2 g-3">
                        {FilterdossiersData.map((item, index) => (
                          <Col key={index}>
                            <Input
                              type="select"
                              onChange={(e) =>
                ...
                <div className="table-responsive">
                  <DataTable
                    ...
                    columns={dossiersListTableDataColumn}
                    striped
                    highlightOnHover
                    subHeader
...
export default CdossiersListContainer;
